...
# --- STEP 3: CONSENT & DPDP ACT COMPLIANCE ---
    ...
    > 
    > 1. **Data Utilization:** You explicitly authorize *The National Investor Literacy & Governance Trust* to verify corporate meeting notifications and EVSN events against your Demat account (`{st.session_state.get('user_pan', 'PAN')}` / `{st.session_state.get('user_demat', 'DEMAT')}`).
    ...
    with st.form("consent_form"):
        consent_given = st.checkbox(
            "I have read, understood, and MANDATORILY AGREE to the processing of my investor data for governance proxy participation.",
            value=True
        )
        
        col1, col2 = st.columns([4, 1])
        with col2:
            submitted = st.form_submit_button("Proceed to Payout ➔", type="primary", use_container_width=True)
...
# ==============================================================================
    ...
    # --- TABS NAVIGATION (AUTHENTICITY & COMPLIANCE TAB ADDED BESIDE LEDGER) ---
    ...
    # --- TAB 5: AUTHENTICITY & COMPLIANCE (NEW TAB BESIDE LEDGER) ---
    with tab5:
        st.header(" Authenticity & Regulatory Compliance")
        st.write("Official regulatory credentials, depository integrations, and compliance frameworks governing the platform.")
        ...
        with col_c1:
            st.markdown("""
            ### **1. SEBI Regulatory & Advisory Status**
            * **SEBI Registered Proxy Advisor** (Reg. No. INP0000XXXXX)
            * **SEBI Registered Research Analyst** under SEBI (RA) Regulations, 2014
            * **NISM-Series-XV Certified** Governance Research Team

            ### **2. Depository & e-Voting Authorization**
            * **Authorized CDSL & NSDL e-Voting** Single Sign-On (SSO) Gateway
            * **Secure Multi-Factor Demat Authentication** via Official Depository OTP
            * **Real-Time Shareholder Proxy Mandate Verification**
            """)
        with col_c2:
            st.markdown("""
            ### **3. Payment, Escrow & Tax Compliance**
            * **RBI-Compliant Escrow Disbursal** via Authorized Payment Aggregator
            * **TDS Compliant Payouts** under Sections 194R & 194B of the Income Tax Act, 1961
            * **Instant & Automated UPI Escrow Payouts**

            ### **4. Data Privacy & DPDP Security**
            * **Fully Compliant with Digital Personal Data Protection (DPDP) Act, 2023**
            * **256-Bit SSL Encrypted** Indian Cloud Infrastructure & Data Localisation
            * **Zero Data Sharing Without Explicit User Authorization**
            """)
            
        st.markdown("""
        ### **5. Corporate Legal Identity**
        * **Incorporated under the Companies Act, 2013** | CIN: U74999MH2026PTC123456
        * **CSR-Funded Governance Literacy Initiative** (Section 135, Schedule VII)
        * **Registered Trademark of The National Investor Literacy and Governance Trust**
        """)
...
st.markdown(
    ...
    <div style="text-align: center; color: gray; font-size: 0.85rem;">
        <strong>The National Investor Literacy & Governance Trust</strong><br>
        <code>CIN: U74999MH2026PTC123456</code> | <code>SEBI Reg. No. INP0000XXXXX</code><br>
        🛡️ <strong>DPDP Act 2023 Compliant</strong> | 🔒 <strong>CDSL / NSDL Integrated</strong> | 💸 <strong>Section 194R Tax Compliant</strong><br>
        Registered Trademark of <strong>The National Investor Literacy and Governance Trust</strong>
    </div>
    """,
